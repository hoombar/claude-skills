...
2. Generate a random filename using a short descriptive prefix based on the diagram content plus a random suffix, e.g. `flow-a3f9b2.png`. Do NOT ask the user for a filename.
3. Run mmdc to convert:
   ```
...
6. Tell the user the filename and provide a clickable link to open the containing folder:
   ```
